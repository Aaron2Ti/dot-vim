  if &background == 'dark'
    ...
    let s:accent0 = '#FF8787'
    let s:accent1 = '#BF4381'
    let s:accent2 = '#EFAA29'
    let s:accent3 = '#48A73E'
    let s:accent4 = '#15ADB8'
    let s:accent5 = '#1F81D9'
    let s:accent6 = '#977AE8'
    let s:accent7 = '#FFE599'
  endif
  ...
  exec "hi Normal guifg=".s:shade5." guibg=".s:shade0
  ...
  exec "hi CursorLineNr        guifg=".s:shade1."  guibg=".s:shade1
  ...
  exec "hi Error               guifg=".s:shade6." guibg=".s:accent0
  exec "hi ErrorMsg            guifg=".s:shade6." guibg=".s:accent0
  ...
  exec "hi MatchParen          guifg=".s:accent7." guibg=".s:shade7
  exec "hi MoreMsg             guifg=".s:shade0." guibg=".s:accent4
  exec "hi NonText             guifg=".s:shade2." guibg=".s:shade0
  exec "hi Operator            guifg=".s:accent3
  exec "hi Pmenu               guifg=".s:shade6." guibg=".s:shade1
  exec "hi PmenuSbar           guifg=".s:accent3." guibg=".s:shade7
  exec "hi PmenuSel            guifg=".s:accent4." guibg=".s:shade7
  exec "hi PmenuThumb          guifg=".s:accent0." guibg=".s:shade2
  exec "hi PreProc             guifg=".s:accent5
  ...
  exec "hi SignatureMarkTextHL guifg=".s:accent6." guibg=".s:shade1." gui=bold"
  ...
  exec "hi Statement           guifg=".s:accent5." gui=none cterm=none"
  exec "hi StatusLine          guifg=".s:shade4." guibg=".s:shade1." gui=none cterm=none"
  exec "hi String              guifg=".s:accent0." gui=none cterm=none"
  ...
  exec "hi Todo                guifg=".s:accent7." guibg=".s:accent1
  exec "hi Type                guifg=".s:accent4." gui=none cterm=none"
  exec "hi Underlined          guifg=".s:accent5
  exec "hi VertSplit           guifg=".s:shade0." guibg=".s:shade3
  exec "hi Visual              guifg=".s:accent7." guibg=".s:shade7
  ...
  exec "hi fzf1                guifg=".s:shade5." guibg=".s:shade1
  exec "hi fzf2                guifg=".s:accent0." guibg=".s:shade1

  let g:ophigh_color_gui = s:accent2
  hi EasyMotionTargetDefault gui=none
